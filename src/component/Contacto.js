        ...
        <div className="row">
          <div className="col">
            <a href="https://www.linkedin.com/in/eleazar-curiel-monjaraz-994305170/" >
              <img src={logolinkedin} className="iconocontacto" alt='Linkedin'  width="100%"/>
            </a>
          </div>
          <div className="col">
            <a href="https://twitter.com/CurielEleazar">
              <img src={logotwiter} className="iconocontacto" alt='Twiter' width="100%"/>
            </a>
          </div>
          <div className="col">
            <a href="https://gitlab.com/eleazar-00">
              <img src={logogitlab} className="iconocontacto" alt='Repositorio Gitlab' width="100%"/>
            </a>
          </div>
          <div className="col">
            <a href="https://github.com/desarrolloCuriel">
              <img src={logogithub} className="iconocontacto" alt='Repositorio GitHub' width="100%"/>
            </a>
          </div>
